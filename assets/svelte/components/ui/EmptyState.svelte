<script>
   ...
   * Empty data display using design tokens.
   *
   * @prop {'default' | 'search' | 'error' | 'success' | 'offline'} [preset='default']
   * @prop {string} [title] - Custom title (overrides preset)
   * @prop {string} [description] - Custom description (overrides preset)
   * @prop {Snippet} [icon] - Custom icon slot
   * @prop {Snippet} [action] - Action button slot
