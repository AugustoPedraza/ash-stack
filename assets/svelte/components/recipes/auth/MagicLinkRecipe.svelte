...
<div class="h-full bg-base-100 overflow-y-auto px-5 py-6">
  {#if success}
    ...
    <div class="flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      <p class="text-muted-foreground mb-8">Successfully signed in via magic link.</p>
  ...
  {:else if checkingLink}
    ...
    <div class="flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      <h1 class="text-xl font-bold text-foreground mb-2">Verifying Link...</h1>
      <p class="text-muted-foreground">Please wait while we sign you in.</p>
    </div>
  {:else if linkSent}
    <!-- Link Sent State -->
    <div class="flex flex-col items-center justify-center min-h-[80vh] text-center max-w-sm mx-auto">
      ...
      <p class="text-muted-foreground mb-2">We sent a magic link to:</p>
  ...
  {:else}
    ...
    <div class="max-w-sm mx-auto pt-10">
      <div class="text-center mb-8">
        <h1 class="text-xl font-semibold text-foreground mb-2">Sign In with Email</h1>
        <p class="text-muted-foreground">We'll send you a magic link to sign in instantly.</p>
      </div>

      {#if error}
        <div class="flex items-center gap-3 p-3 bg-destructive/10 border border-destructive/30 rounded-lg text-destructive text-sm mb-6">
