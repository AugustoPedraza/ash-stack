...
<div class="h-full bg-base-100 overflow-y-auto px-5 py-6">
  {#if deleted}
    ...
    <div class="flex flex-col items-center justify-center min-h-[80vh] text-center">
      <div class="w-20 h-20 rounded-full bg-base-200 text-text-disabled flex items-center justify-center mb-6">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
        </svg>
      </div>
      <h1 class="text-xl font-semibold text-text mb-2">Account Deleted</h1>
      <p class="text-text-secondary mb-8">Your account and all data have been permanently removed.</p>
  ...
  {:else}
    <div class="max-w-md mx-auto pt-6">
      <h1 class="text-xl font-semibold text-text mb-6">Account Settings</h1>

      <!-- Normal Settings Section -->
      <section class="mb-8">
        <h2 class="text-lg font-semibold text-text mb-4">Export Data</h2>
        <Card variant="flat">
      ...
      <section>
        ...
        <div class="border border-error/30 rounded-lg overflow-hidden">
          <div class="p-4 bg-error-soft/30">
            <h3 class="font-medium text-text mb-1">Delete Account</h3>
            ...
            {:else}
              <!-- Confirmation Form -->
              <div class="p-4 bg-surface rounded-lg border border-error/30 mt-4">
                <div class="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <h4 class="font-medium text-text">Are you absolutely sure?</h4>
                    <p class="text-sm text-text-secondary mt-1">
                      This will permanently delete your account, including all projects, files, and settings.
                      <strong class="text-text">This cannot be undone.</strong>
                    </p>
                  </div>
                </div>
                ...
                <div class="space-y-4">
                  <div class="flex flex-col gap-1.5">
                    <label class="text-sm text-text-secondary" for="confirmDelete">
                      Type <strong class="text-text">{CONFIRMATION_TEXT}</strong> to confirm:
                    </label>
                    <Input
                      id="confirmDelete"
                      type="text"
        ...
        <div class="flex gap-3 p-0">
          ...
          <div>
            <p class="text-sm text-text-secondary">
              <strong class="text-text">Before deleting:</strong> Consider exporting your data first. Once deleted, we cannot recover your account or any associated information.
            </p>
          </div>
        </div>
      </Card>
