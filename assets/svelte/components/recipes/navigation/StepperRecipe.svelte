...
<div class="h-full bg-background overflow-y-auto px-5 py-6">
  <div class="max-w-md mx-auto">
    <div class="mb-8">
      <h1 class="text-xl font-semibold text-foreground mb-2">Progress</h1>
      <p class="text-muted-foreground text-sm">Mobile-friendly progress indicators for multi-step flows.</p>
    </div>

    <div class="flex flex-col gap-6">
      <!-- Progress Bar with Label -->
      <div class="flex flex-col gap-1.5">
        <span class="text-sm font-medium text-foreground">Progress Bar</span>
        <p class="text-xs text-muted-foreground mb-2">Most common mobile pattern. Simple and clear.</p>
      ...
      <!-- Dots Indicator -->
      <div class="flex flex-col gap-1.5">
        <span class="text-sm font-medium text-foreground">Dots Indicator</span>
        <p class="text-xs text-muted-foreground mb-2">Good for onboarding flows (2-5 steps).</p>
        ...
        <div class="p-4 border border-border-strong rounded-lg bg-background">
          ...
          <p class="mt-3 text-sm text-muted-foreground text-center">{currentLabel}</p>
        </div>
      </div>

      <!-- Fraction Display -->
      <div class="flex flex-col gap-1.5">
        <span class="text-sm font-medium text-foreground">Fraction Display</span>
        <p class="text-xs text-muted-foreground mb-2">Minimal, shows exact position.</p>

        <div class="p-4 border border-border-strong rounded-lg bg-background">
          <div class="flex items-center justify-center gap-1">
            <span class="text-2xl font-semibold text-primary">{currentStep}</span>
            <span class="text-lg text-text-disabled">/</span>
            <span class="text-lg text-muted-foreground">{steps.length}</span>
          </div>
          <p class="mt-2 text-sm text-muted-foreground text-center">{currentLabel}</p>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-1.5">
        ...
        <p class="text-xs text-muted-foreground mb-2">Progress integrated with navigation.</p>
        ...
        <div class="border border-border-strong rounded-lg bg-background overflow-hidden">
          ...
          <!-- Content -->
          <div class="p-4">
            <p class="text-sm text-muted-foreground">Step content goes here...</p>
          </div>
